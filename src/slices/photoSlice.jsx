...
export const getAllUserPhotos = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    ...
    const data = await photoService.getAllUserPhotos(id, token)
...
export const updatePhoto = createAsyncThunk("photo/update",
  async (photoData, thunkAPI) => {
    ...
    try {
      const data = await photoService.updatePhoto(photoData, photoData.id, token);
...
export const getPhotoById = createAsyncThunk("photo/getphoto",
  async (id, thunkAPI) => {
